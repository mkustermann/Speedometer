...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  A.TodoMVCState.prototype = {
    ...
    build$1(context) {
      var t8, t9, t10, t11, t12, t13, dataId, _0_2, isActive, t14, t15, t16, _i, state, _this = this, _null = null, _s5_ = "none;", _s6_ = "block;",
        ...
        t7 = _this.activeCount > 0 ? _null : B.LinkedHashMap_LinkedHashMap$_literal(["checked", ""], t1, t1);
      ...
      for (t9 = A.MapExtensions_get_keyValues(t5, type$.int, type$.Record_2_bool_isActive_and_String_todo), t10 = B._instanceType(t9), t9 = new B.MappedIterator(J.get$iterator$ax(t9.__internal$_iterable), t9._f, t10._eval$1("MappedIterator<1,2>")), t10 = t10._rest[1], t11 = type$.ValueKey_String; t9.moveNext$0();) {
        ...
        if (t13) {
          ...
          t16 = isActive ? _null : B.LinkedHashMap_LinkedHashMap$_literal(["checked", ""], t1, t1);
  ...
  A._callWithValue__closure.prototype = {
    call$0() {
      var t1 = this.target,
        type = B.IterableExtensions_get_firstOrNull(new B.WhereIterable(C.List_T5C, new A._callWithValue___closure(t1.type), type$.WhereIterable_InputType));
      $label0$0: {
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "_cachedHtmlAnchorElementConstructor", "$get$_cachedHtmlAnchorElementConstructor", () => B.getProperty(B.staticInteropGlobalContext(), "HTMLAnchorElement"));
    _lazyFinal($, "_cachedHtmlTextAreaElementConstructor", "$get$_cachedHtmlTextAreaElementConstructor", () => B.getProperty(B.staticInteropGlobalContext(), "HTMLTextAreaElement"));
    _lazyFinal($, "_cachedHtmlOptionElementConstructor", "$get$_cachedHtmlOptionElementConstructor", () => B.getProperty(B.staticInteropGlobalContext(), "HTMLOptionElement"));
  })();
};
;
((d, h) => {
...
})($__dart_deferred_initializers__, "6S4V8OAGHLWFFiL5uCYe/mVgqAw=");
;
