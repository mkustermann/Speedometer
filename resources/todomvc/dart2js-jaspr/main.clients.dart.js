// Generated by dart2js (, trust primitives, omit checks, lax runtime type, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.8.0-edge.04476874bd8f4408c2f29db9b5a2a3d61036f44e.
...
(function dartProgram() {
  ...
  A.TodoMVCState.prototype = {
    ...
    build$1(context) {
      var t8, t9, t10, t11, t12, t13, dataId, _0_2, isActive, t14, t15, t16, _i, state, _this = this, _null = null, _s5_ = "none;", _s6_ = "block;",
        ...
        t7 = _this.activeCount > 0 ? _null : A.LinkedHashMap_LinkedHashMap$_literal(["checked", ""], t1, t1);
      ...
      for (t9 = A.MapExtensions_get_keyValues(t5, type$.int, type$.Record_2_bool_isActive_and_String_todo), t10 = A._instanceType(t9), t9 = new A.MappedIterator(J.get$iterator$ax(t9.__internal$_iterable), t9._f, t10._eval$1("MappedIterator<1,2>")), t10 = t10._rest[1], t11 = type$.ValueKey_String; t9.moveNext$0();) {
        ...
        if (t13) {
          ...
          t16 = isActive ? _null : A.LinkedHashMap_LinkedHashMap$_literal(["checked", ""], t1, t1);
  ...
  (function installTearOffs() {
    ...
    _static_0(A, "main_clients____loadLibrary_prefix0$closure", "__loadLibrary_prefix0", 26);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null(@)", "~(@)", "~(JSObject)", "~(String)", "~(Element)", "~(~())", "Null()", "Null(@,StackTrace)", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(List<@>)", "Future<@>(int)", "~(int,@)", "~(Object,StackTrace)", "~(Object[StackTrace?])", "Null(Object,StackTrace)", "~(@,@)", "~(Object?,Object?)", "Component(Map<String,@>)/(String)", "Component(Map<String,@>)(Component(Map<String,@>))", "Future<Component(Map<String,@>)>()", "Component(Map<String,@>)(~)", "~(String,EventBinding)", "Future<@>()", "~(String,~(JSObject))", "~(@,String,StackTrace?,List<String>?,List<String>?)", "Object?()", "bool(InputType)", "String(Match)", "Element?(Element?)", "Null(Null)", "bool(int,+isActive,todo(bool,String))", "Component(Map<String,@>)", "int(@,@)", "~(@,String,StackTrace?)", "Map<String,~(JSObject)>({onChange:~(1^)?,onClick:~()?,onInput:~(0^)?})<Object?,Object?>", "int(Element,Element)", "String(MapEntry<String,String>)"],
