...
(function dartProgram() {
  ...
  A.App.prototype = {
    build$1(context) {
      ...
      t6.$indexSet(0, "href", "http://todomvc.com");
      t5 = A.LinkedHashMap_LinkedHashMap$_empty(t5, type$.void_Function_JSObject);
      t7 = type$.dynamic;
      t5.addAll$1(0, A.events__events$closure().call$2$1$onClick(_null, t7, t7));
      return A._setArrayType([new A.TodoMVC(_null), A.footer(A._setArrayType([t2, t3, A.p(A._setArrayType([new A.Text("Part of ", _null), new A.DomComponent("a", _null, _null, _null, t6, t5, _null, t4, _null)], t1))], t1), "info", _null)], t1);
    }
  };
  A.TodoMVC.prototype = {
    createState$0() {
  ...
  A.TodoMVCState.prototype = {
    ...
    build$1(context) {
      ...
      return A._setArrayType([new A.DomComponent("section", "root", "todoapp", _null, _null, _null, _null, A._setArrayType([new A.DomComponent("header", _null, "header", _null, t2, _null, _null, t4, _null), new A.DomComponent("main", _null, "main", new A._RawStyles(t6), _null, _null, _null, t8, _null), A.footer(A._setArrayType([new A.TodoActiveCount(t7, _null), t10, A.button(A._setArrayType([new A.Text("Clear completed", _null)], t3), "clear-completed", _this.get$clearCompleted(), new A._RawStyles(t1))], t3), "footer", new A._RawStyles(t9))], t3), _null)], t3);
    }
  };
  ...
  (function installTearOffs() {
    ...
    _static_2(A, "framework_Element__sort$closure", "Element__sort", 28);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A.DomRenderObject_updateElement_closure, A.DomRenderObject_updateElement_closure1, A.EventBinding_closure, A.events_closure, A._callWithValue_closure, A._callWithValue___closure, A.Element_updateChildren_replaceWithNullIfForgotten, A.Element_detachRenderObject_closure, A.Element__updateAncestorSiblingRecursively_closure, A._InactiveElements__unmount_closure, A.TodoMVCState_clearCompleted__closure, A.TodoMVCState_build_closure, A.TodoRowHeaderState_build_closure0, A.TodoRowState_build_closure, A.NewTodo_build_closure, A._EventStreamSubscription_closure]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(JSObject)", "~(@)", "~(Element)", "~(~())", "Null(@)", "Null()", "~(String)", "~(Todo)", "Null(int,int)", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "~(@,@)", "~(Object?,Object?)", "~(String,EventBinding)", "String(MapEntry<String,String>)", "~(String,~(JSObject))", "Object?()", "bool(InputType)", "Element?(Element?)", "bool(Todo)", "int(@,@)", "Map<String,~(JSObject)>({onChange:~(1^)?,onClick:~()?,onInput:~(0^)?})<Object?,Object?>", "int(Element,Element)"],
